...
class KERNELS:
  ...
  def __init__(self,mell,Type='upol'):
    ...
    elif Type=='collins':     self.load_Col_spl()
    elif Type=='sivers':      self.load_Siv_spl()
    elif Type=='boermulders': self.load_BM_spl()
